...
@Service
@Log4j
public class SnilsValidationServiceImpl implements ImportService {
  @Autowired
  private JobLauncher jobLauncher;

  @Autowired
  private Job snilsValidationJob;
  ...
  public void start(String jobId) {
    ...
    try {
      ...
      JobExecution jobExecution = jobLauncher.run(snilsValidationJob, jobParameters);
      BatchStatus status;
      do {
